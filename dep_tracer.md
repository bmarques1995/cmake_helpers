...
`trace_dependency(<NAME> <INSTALL_SCRIPT> [VERSION] [COMPONENTS...] [USE_VSTOOLS] [LIMIT_SEARCH_PATHS] [<COMPONENT_INFIX>] [<EXTRA_SUFFIXES>] [<PYTHON_SUFFIX_NAME>])`:
...
`trace_library(<NAME> <INSTALL_SCRIPT> [USE_VSTOOLS] [LIMIT_SEARCH_PATHS] [<PYTHON_SUFFIX_NAME>])`:
...
`trace_file(<NAME> <INSTALL_SCRIPT> <LOCATION> <EXTENSION> [LIMIT_SEARCH_PATHS]  [<PYTHON_SUFFIX_NAME>])`:
...
`trace_installable_file(<NAME> <INSTALL_SCRIPT> <LOCATION> <EXTENSION> [LIMIT_SEARCH_PATHS] [<PYTHON_SUFFIX_NAME>])`:
