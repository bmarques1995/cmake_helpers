...
function(set_shell_program SCRIPT_FILENAME)
    ...
    if(MSVC)
        string(REGEX REPLACE "(Community|Professional|Enterprise).*" "\\1" VS_INSTALL_PATH "${CMAKE_C_COMPILER}")
        set(VS_SCRIPT_LOCATION "${VS_INSTALL_PATH}/Common7/Tools/" PARENT_SCOPE)
    endif()
    if(WIN32)
...
macro(download_package INSTALL_SCRIPT USE_VSTOOLS)
    ...
    if(USE_VSTOOLS)
        execute_process(COMMAND ${SCRIPT_RUNNER} ${SCRIPT_ARG} ${INSTALL_SCRIPT} ${CMAKE_BUILD_TYPE} ${CMAKE_INSTALL_PREFIX} ${PROJECT_SOURCE_DIR} ${VS_SCRIPT_LOCATION})
    else()
