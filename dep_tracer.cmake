...
macro(download_package INSTALL_SCRIPT USE_VSTOOLS PYTHON_NAME_SUFFIX WORKING_DIR)
    ...
    if(${USE_VSTOOLS})
        execute_process(COMMAND ${SCRIPT_RUNNER} ${SCRIPT_ARG} ${INSTALL_SCRIPT} ${PROJECT_BUILD_TYPE} ${CMAKE_INSTALL_PREFIX} ${PROJECT_SOURCE_DIR} ${CMAKE_C_COMPILER} WORKING_DIRECTORY ${WORKING_DIR})
    else()
        execute_process(COMMAND ${SCRIPT_RUNNER} ${SCRIPT_ARG} ${INSTALL_SCRIPT} ${PROJECT_BUILD_TYPE} ${CMAKE_INSTALL_PREFIX} ${PROJECT_SOURCE_DIR} WORKING_DIRECTORY ${WORKING_DIR})
    endif()
