...
macro(trace_dependency)
    set(oneValueArgs "INSTALL_SCRIPT" "NAME" "VERSION" "COMPONENT_INFIX" "PYTHON_NAME_SUFFIX")
    ...
    if(NUMBER_OF_COMPONENTS EQUAL 0)
        if(${PACKAGE_CONTROLLER_NAME}_FOUND)
            ...
            message(STATUS "`${PACKAGE_CONTROLLER_INSTALL_SCRIPT}`, `${TREATED_USE_VSTOOLS}` and `${PACKAGE_CONTROLLER_PYTHON_NAME_SUFFIX}` values")
            download_package(${PACKAGE_CONTROLLER_INSTALL_SCRIPT} ${TREATED_USE_VSTOOLS} ${PACKAGE_CONTROLLER_PYTHON_NAME_SUFFIX})
        endif()
    else()
...
macro(trace_library)
    set(oneValueArgs "INSTALL_SCRIPT" "NAME" "PYTHON_NAME_SUFFIX")
    ...
    if(NOT ${LIBRARY_CONTROLLER_NAME}_FOUND)
        download_package(${LIBRARY_CONTROLLER_INSTALL_SCRIPT} ${TREATED_USE_VSTOOLS} ${LIBRARY_CONTROLLER_PYTHON_NAME_SUFFIX})
    else()
...
macro(trace_file)
    set(oneValueArgs "INSTALL_SCRIPT" "LOCATION" "NAME" "EXTENSION" "PYTHON_NAME_SUFFIX")
    set(multiValueArgs "COMPONENTS")
    ...
    if(NOT ${FILE_CONTROLLER_NAME}_FOUND)
        download_file(${FILE_CONTROLLER_INSTALL_SCRIPT} ${FILE_CONTROLLER_PYTHON_NAME_SUFFIX})
    else()
...
macro(trace_installable_file)
    ...
    if(NOT ${FILE_CONTROLLER_NAME}_FOUND)
        download_package(${FILE_CONTROLLER_INSTALL_SCRIPT} ${TREATED_USE_VSTOOLS} ${FILE_CONTROLLER_PYTHON_NAME_SUFFIX})
    else()
        message(STATUS "${FILE_CONTROLLER_NAME} was found")
    endif()
...
macro(download_package INSTALL_SCRIPT USE_VSTOOLS PYTHON_NAME_SUFFIX)
