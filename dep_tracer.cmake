...
macro(trace_library)
    ...
    if(TREATED_LIMIT_SEARCH_PATHS)
        find_library(${LIBRARY_CONTROLLER_NAME}_FOUND NAMES ${LIBRARY_CONTROLLER_NAME} PATHS ${CMAKE_INSTALL_PREFIX} NO_DEFAULT_PATH)
    else()
    ...
    if(TREATED_LIMIT_SEARCH_PATHS)
        find_library(${LIBRARY_CONTROLLER_NAME}_FOUND NAMES ${LIBRARY_CONTROLLER_NAME} PATHS ${CMAKE_INSTALL_PREFIX} NO_DEFAULT_PATH REQUIRED)
    else()
